...
Original file is located at
    https://colab.research.google.com/drive/1828GQLBsi3caoBW6RSn0L778JvrNHDx9
"""

from google.colab import drive
drive.mount('/content/drive')

folder_path = '/content/drive/MyDrive/FYP_BookGenie'
...
with open(f"{folder_path}/app.py", "w") as f:
